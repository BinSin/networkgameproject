...
public class Game extends Canvas implements Runnable {
    ...
    public static final int HEIGHT = WIDTH / 12 * 9;//210
    public static final int SCALE = 3;
    public static final String NAME = "Game";
    public static final Dimension DIMENSIONS = new Dimension(WIDTH * SCALE, HEIGHT * SCALE);//840*630
    ...
    private int randomColour = Colours.get(-1, 111, 0, 300);
    ...
    public ChatVisual chatVisual= new ChatVisual(name="sullae");//chatServer start 
...
/*  public static synchronized void playSound() {
    	    ...
    	    public void run() {
    	      try {
    	        ...
    	        AudioInputStream inputStream = AudioSystem.getAudioInputStream(
    	          Game.class.getResourceAsStream("/level1.mp3"));
    ...
    public void init() {
        ...
        // 클라이언트는 이 부분 그대로
        //name =  JOptionPane.showInputDialog(this, "캐릭터 이름을 입력해 주세요.");
        name = chatVisual.id;
    ...
    public synchronized void start() {
        ...
        if (!isApplet) {
        	// client는 이 부분 제거
            if (JOptionPane.showConfirmDialog(this, "방을 생성하시겠습니까?") == 0) {
    ...
    public void run() {
        ...
        // 속도 조절 가능
        double nsPerTick = 1000000000D / 35D;
